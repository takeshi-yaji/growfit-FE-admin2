    ...
    <div class="px-32">
      <div class="flex justify-between items-center">
        ...
        <div class="flex justify-center items-center">
          <BaseButton color="blue" @click="saveAsDraft">下書き保存</BaseButton>
          <BaseButton class="ml-4" color="orange" @click="saveAsPublic">公開</BaseButton>
        </div>
      </div>
      <span class="flex mt-8">タイトル</span>
      <BaseTextField class="mt-4"></BaseTextField>
      ...
      <div class="flex justify-end items-center">
        <BaseButton color="red" class="mt-8" @click="deleteItem">削除</BaseButton>
      </div>
    </div>
  </div>
</template>
